export const ADVANTAGES = [
  ...
  {
    src: 'images/bu2.png',
    html: '<strong class="info-title">Легкие и удобные</strong> <p class="info-text">Подходит <strong>для всех типов ног</strong>. Эта обувь позволит вам чувствовать себя так, словно вы <strong>ходите по воздуху</strong>. Это максимально <b>уменьшит боль в ногах</b> при стоянии или ходьбе в течение длительного периода времени.</p>',
  },
  {
    src: 'images/bu1.png',
